...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sube fotos de tus pins de viaje sobre fondo verde y obtén medidas, forma y ubicación automáticas." },
      { property: "og:title", content: "Pin Digitizer — Cataloga tu colección de pins" },
      { property: "og:description", content: "Sube fotos de tus pins de viaje sobre fondo verde y obtén medidas, forma y ubicación automáticas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Pin Digitizer — Cataloga tu colección de pins" },
      { name: "twitter:description", content: "Sube fotos de tus pins de viaje sobre fondo verde y obtén medidas, forma y ubicación automáticas." },
