// ISO 3166-1 country list with Spanish names (official + widely used forms).
// Used to constrain País selection to consistent Spanish spellings.
export const COUNTRIES_ES: { code: string; name: string }[] = [
...
export function findCountryByName(name: string | null | undefined) {
  ...
  return COUNTRIES_ES.find((c) => c.name.toLowerCase() === n) ?? null;
}
